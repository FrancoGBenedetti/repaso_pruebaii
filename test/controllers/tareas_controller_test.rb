...
class TareasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tarea" do
    assert_difference('Tarea.count') do
      post tareas_url, params: { tarea: { content: @tarea.content, image: @tarea.image, title: @tarea.title } }
    end
  ...
  test "should update tarea" do
    patch tarea_url(@tarea), params: { tarea: { content: @tarea.content, image: @tarea.image, title: @tarea.title } }
